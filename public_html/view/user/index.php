   ...
   <div class="app">
    ...
    Hola <?php echo ucfirst($_SESSION['nombre']); ?>
     <div class="header-menu">
      <a class="menu-link is-active" href="#">Mis Apps</a>
      <a class="menu-link notify" href="#">Mi inventario</a>
      <a class="menu-link" href="#">Tienda</a>
      <a class="menu-link notify" <a href="../../controller/cerrarSesion.php">Cerrar</a>
     ...
     <div class="header-profile">
      ...
      <img class="profile-img" src="https://e7.pngegg.com/pngimages/223/244/png-clipart-computer-icons-avatar-user-profile-avatar-heroes-rectangle.png" alt="">
     </div>
    </div>
    <div class="wrapper">
     <div class="left-side">
      <div class="side-wrapper">
       <div class="side-title">Aplicaciones</div>
       <div class="side-menu">
        <a href="#">
      ...
      <div class="side-wrapper">
       <div class="side-title">Mas Herramientas</div>
       <div class="side-menu">
        <a href="#">
         <svg viewBox="0 0 512 512" fill="currentColor">
     ...
     <div class="main-container">
      <div class="main-header">
       <a class="menu-link-main" href="#">Todas tus herramientas</a>
       <div class="header-menu">
        <a class="main-header-link is-active" href="#">Escritorio</a>
        <a class="main-header-link" href="#">Movil</a>
      ...
      <img width="45" height="45" src="https://cdn-icons-png.flaticon.com/512/2331/2331716.png " >
<br><br><br><br>
          
        Stock Closet Interactivo
         </h3>
         <div class="content-text"> Elige tu prenda con la funcion Drag-and-Drop  , rapido y sencillo</div>
         <button class="content-button">Inicia la experiencia</button>
        </div>
        <img class="content-wrapper-img" src="https://cdn-icons-png.flaticon.com/512/2362/2362018.png" alt="">
       </div>
       <div class="content-section">
        <div class="content-section-title">Disponibles</div>
        <ul>
         <li class="adobe-product">
          <div class="products">
            <img width="35" height="35" src="https://cdn-icons-png.flaticon.com/512/2362/2362018.png" > &nbsp;&nbsp;
           Cloth Smart
          </div>
          <span class="status">
           <span class="status-circle green"></span>
           Actualizada Ver.1.0 </span>
          <div class="button-wrapper">
           <a href="#"><button class="content-button status-button open">Abrir</button>
         ...
         <li class="adobe-product">
          <div class="products">
            <img width="35" height="35" src="https://i.pinimg.com/originals/2d/81/26/2d812684f36c8f6850685393c6f9f9b4.png" > &nbsp;&nbsp;   
           Voice Smart
          </div>
          ...
          <div class="button-wrapper">
           <a href="voz.php"><button class="content-button status-button open">Abrir</button>
           <div class="pop-up">
            <div class="pop-up__title">Actualizar
         ...
         <li class="adobe-product">
          <div class="products">
            <img width="35" height="35" src="https://cdn2.iconfinder.com/data/icons/education-technology/64/Interactive_Learning-digital-interaction-technology-512.png" > &nbsp;&nbsp;   

            Interactive Box
          </div>
          <span class="status">
           <span class="status-circle green"></span>
           Atualizada Ver.2.5</span>
          <div class="button-wrapper">
       ...
       <div class="content-section">
        <div class="content-section-title">Apps Proximamente</div>
        <div class="apps-card">
         <div class="app-card">
          <span>
             <img width="35" height="35" src="https://cdn-icons-png.flaticon.com/512/2103/2103835.png" > &nbsp;&nbsp;
          Inteligencia Artificial Smart
          </span>
          <div class="app-card__subtext">Proximamente...</div>
          <div class="app-card-buttons">
           <button class="content-button status-button">Obtener Preventa</button>
           <div class="menu"></div>
          </div>
         </div>
         <div class="app-card">
          <span>
            <img width="35" height="35" src="https://cdn-icons-png.flaticon.com/512/3056/3056516.png" > &nbsp;&nbsp;
          Vr Closet
          </span>
          <div class="app-card__subtext">Proximamente...</div>
          <div class="app-card-buttons">
         ...
         <div class="app-card">
          <span>
            <img width="35" height="35" src="https://cdn-icons-png.flaticon.com/512/3612/3612272.png" > &nbsp;&nbsp;
           Aprende Vr
          </span>
          <div class="app-card__subtext">Proximamente...</div>
          <div class="app-card-buttons">
