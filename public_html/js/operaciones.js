$('#login').click(function(){
  ...
  $.ajax({
    method: 'POST',
    // La ruta se hace como si estuvieramos en el index y no en operaciones por esa razon no utilizamos ../ para ir a controller
    url: 'controller/loginController.php',
    // El primer parametro es la variable de php y el segundo es el dato que enviamos
    ...
    success: function(res){
      ...
      if(res == 'error_1'){
        /*
        Para usar sweetalert es muy sencillo, haces un alert
        solo que esta vez enviaras 3 parametros separados por comas, el primero
        ...
        warning: muestra icono de advertencia amarillo y error: muestra una animacion con una X
        */
